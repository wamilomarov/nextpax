...
//        2. minimum 4 days in a row - costs 800 eur + 400 eur per extra person for 4 nights (200 + 100 a night)
    ...
    public function testPriceCombination()
    {
//        3 prices:
//        1. minimum 1 day in a row - costs 250 eur + 120 eur per extra person 2022-12-05
//        2. minimum 1 day in a row - costs 200 eur + 120 eur per extra person 2022-12-06
//        2. minimum 1 day in a row - costs 190 eur + 120 eur per extra person 2022-12-06
        ...
        Price::factory()
            ->createOne([
                ...
                'duration' => 1,
                'period_from' => Carbon::parse('2022-12-05'),
                'period_till' => Carbon::parse('2022-12-05'),
                'extra_person_price' => 12000,
                'amount' => 25000,
                'currency' => 'EUR',
                'extra_person_price_currency' => 'EUR',
        ...
        Price::factory()
            ->createOne([
                ...
                'weekdays' => "0|1|2|3|4|5|6",
                'duration' => 1,
                'period_from' => Carbon::parse('2022-12-06'),
                'period_till' => Carbon::parse('2022-12-06'),
                'extra_person_price' => 12000,
                'amount' => 20000,
                'currency' => 'EUR',
                'extra_person_price_currency' => 'EUR',
        ...
        $result = $method->invokeArgs($service, [$arrivalDate, $availability->prices, 2, $persons]);

        // 1 night 370 + 1 night 310
        $this->assertEquals(68000, $result);
    }
}
